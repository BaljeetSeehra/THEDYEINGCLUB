...
const createNavbar = () => {
    ...
    <li class="link-item"><a href="/index" class="link active">home</a></li>
    <li class="link-item"><a href="#" class="link">products</a></li>
    <li class="link-item"><a href="/about" class="link active">about</a></li>
    ...
    <div class="cart" onclick="location.href = '/cart'">
        <img src="../img/cart (1).png" class="cart-icon" alt="">
        <span class="cart-item-count">00</span>
    </div>

    <div class="user">
        <img src="../img/user (1).png" class="user-icon" alt="">
